class ServicesController < Spree::BaseController
...
#                  role_user = RolesUser.create(:user_id => user.id, :role_id => user_role.id)
                end
                # flash and sign in
                flash[:myinfo] = 'Your account on Study Oracle Apps has been created via ' + provider.capitalize + '. In your profile you can change your personal information and add a local password.'

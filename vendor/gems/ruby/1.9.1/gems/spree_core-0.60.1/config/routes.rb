Rails.application.routes.draw do
  match "/ship_list" => "products#ship_list"
  match "/filter_by_taxon_all" => "products#filter_by_taxon_all"
  match '/auth/:service/callback' => 'services#create'
  get "/products/load_ship_list"=>"products#load_ship_list"
  get "/products/ship_list"=>"products#ship_list"
  get "/products/filter_by_title" => "products#filter_by_title"
  get "/products/filter_by_taxon" => "products#filter_by_taxon"
  get "/products/remove_from_cart" => "products#remove_from_cart"
